...
<?= Popup::widget([
	...
	'data' => [ 'model' => 'Option Group', 'app' => 'main', 'controller' => 'crud', 'action' => 'bulk', 'url' => "core/optiongroup/bulk" ]
]) ?>

<?= Popup::widget([
	'title' => 'Delete Option Group', 'size' => 'medium',
	'templateDir' => Yii::getAlias( "$themeTemplates/widget/popup/grid" ), 'template' => 'delete',
	'data' => [ 'model' => 'Option Group', 'app' => 'main', 'controller' => 'crud', 'action' => 'delete', 'url' => "core/optiongroup/delete?id=" ]
]) ?>
