...
<div class="box-crud-wrap">
	<div class="box-crud-wrap-main">
		...
		<div class="box box-crud">
			...
			<div class="box-content-wrap frm-split-40-60">
				<div class="box-content">
					...
					<div class="row">
						<div class="col col2">
							<?= Yii::$app->formDesigner->getIconCheckbox( $form, $model, 'group', [ 'class' => 'cmt-checkbox cmt-choice cmt-field-group', 'group-target' => 'group-role', 'disabled' => true ] ) ?>
						</div>
					</div>-->
				</div>
			</div>
		...
		<?php if( count( $permissions ) > 0 ) { ?>
			...
			<div class="box box-crud">
				<div class="box-header">
					<div class="box-header-title">Assigned <?= ucfirst( $type ) ?> Permissions</div>
				</div>
				<div class="box-content">
					<div class="box-content">
		...
		<?php if( count( $spermissions ) > 0 ) { ?>
			...
			<div class="box box-crud">
				<div class="box-header">
					<div class="box-header-title">Assigned System Permissions</div>
				</div>
				<div class="box-content">
					<div class="box-content">
						<div class="row padding padding-small-v">
