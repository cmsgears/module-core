...
$this->title 	= 'All Testimonials | ' . $coreProperties->getSiteTitle();
			...
			<tbody>
				...
				?>
					<tr>
						...
						<td class="actions">
							<span title="Update Testimonial"><?= Html::a( "", [ "update?id=$id" ], [ 'class' => 'cmti cmti-edit' ] )  ?></span>
							<span title="Delete Testimonial"><?= Html::a( "", [ "delete?id=$id" ], [ 'class' => 'cmti cmti-close-c-o' ] )  ?></span>
						</td>
					</tr>
				<?php } ?>
			</tbody>
