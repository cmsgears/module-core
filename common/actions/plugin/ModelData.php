...
/**
 * ModelData Action add/update the plugin data by identifying the appropriate parent.
 *
 * @since 1.0.0
 */
class ModelData extends \cmsgears\core\common\actions\base\ModelAction {
	...
	public function run( $id ) {
		...
		if( isset( $model ) && isset( $pluginId ) && isset( $formType ) ) {
			...
			$pluginObj = new $pluginClass( [ 'id' => $pluginId, 'model' => $model, 'admin' => $this->admin ] );
