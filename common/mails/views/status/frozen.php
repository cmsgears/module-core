...
<table cellspacing="0" cellpadding="0" border="0" margin="0" padding="0" width="80%" align="center" class="ctmax">
	...
	<tr>
		<td>
			<font face="Roboto, Arial, sans-serif">Unfortunately, <?= $modelName ?> has been frozen for further activities. Though <?= $modelName ?> will continue to be functional with restricted activities. The details are as mentioned below:</font>
		</td>
	</tr>
	<tr><td height="20"></td></tr>
	<tr>
