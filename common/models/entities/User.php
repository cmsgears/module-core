...
class User extends CmgEntity implements IdentityInterface {
    ...
    public function rules() {
        ...
        $rules = [
            ...
            [ [ 'email', 'username', 'passwordHash', 'firstName', 'lastName', 'phone', 'avatarUrl', 'websiteUrl', 'verifyToken', 'resetToken', 'authKey', 'accessToken' ], 'string', 'min' => 1, 'max' => CoreGlobal::TEXT_XLARGE ]
        ];
