...
CREATE TABLE `cmg_core_template` (
  ...
  `data` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_template_1` (`createdBy`),
  KEY `fk_template_2` (`modifiedBy`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cmg_core_model_activity` (
  ...
  `content` mediumtext COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_model_activity_1` (`userId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
ALTER TABLE `cmg_core_theme`
	ADD CONSTRAINT `fk_theme_1` FOREIGN KEY (`createdBy`) REFERENCES `cmg_core_user` (`id`),
  	ADD CONSTRAINT `fk_theme_2` FOREIGN KEY (`modifiedBy`) REFERENCES `cmg_core_user` (`id`);

--
-- Constraints for table `cmg_core_template`
--
ALTER TABLE `cmg_core_template`
	ADD CONSTRAINT `fk_template_1` FOREIGN KEY (`createdBy`) REFERENCES `cmg_core_user` (`id`),
  	ADD CONSTRAINT `fk_template_2` FOREIGN KEY (`modifiedBy`) REFERENCES `cmg_core_user` (`id`);
...
ALTER TABLE `cmg_core_city`
	ADD CONSTRAINT `fk_city_1` FOREIGN KEY (`countryId`) REFERENCES `cmg_core_country` (`id`) ON DELETE CASCADE,
	ADD CONSTRAINT `fk_city_2` FOREIGN KEY (`provinceId`) REFERENCES `cmg_core_province` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `cmg_core_address`
  	...
  	ADD CONSTRAINT `fk_address_3` FOREIGN KEY (`cityId`) REFERENCES `cmg_core_city` (`id`);
...
ALTER TABLE `cmg_core_gallery`
	ADD CONSTRAINT `fk_gallery_1` FOREIGN KEY (`siteId`) REFERENCES `cmg_core_site` (`id`),
	ADD CONSTRAINT `fk_gallery_2` FOREIGN KEY (`templateId`) REFERENCES `cmg_core_template` (`id`),
  	ADD CONSTRAINT `fk_gallery_3` FOREIGN KEY (`createdBy`) REFERENCES `cmg_core_user` (`id`),
  	ADD CONSTRAINT `fk_gallery_4` FOREIGN KEY (`modifiedBy`) REFERENCES `cmg_core_user` (`id`);
...
ALTER TABLE `cmg_core_model_activity`
  	ADD CONSTRAINT `fk_model_activity_1` FOREIGN KEY (`userId`) REFERENCES `cmg_core_user` (`id`) ON DELETE CASCADE;
