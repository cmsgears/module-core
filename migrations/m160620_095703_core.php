...
class m160620_095703_core extends Migration {
	...
	private function upTemplate() {
		...
		$this->createTable( $this->prefix . 'core_template', [
			...
			'dataForm' => $this->string( Yii::$app->core->xxxLargeText )->defaultValue( null ),
			'attributesForm' => $this->string( Yii::$app->core->xxxLargeText )->defaultValue( null ),
			'configForm' => $this->string( Yii::$app->core->xxxLargeText )->defaultValue( null ),
			'settingsForm' => $this->string( Yii::$app->core->xxxLargeText )->defaultValue( null ),
			'renderer' => $this->string( Yii::$app->core->mediumText )->defaultValue( null ),
